...
if (isset($_POST["submit"])) {
    ...
    if(move_uploaded_file($temp, 'img/'.$gambar_baru)){
        $query =  mysqli_query($conn,"INSERT INTO keluhann VALUES ('','$nama','$nik','$gender','$tanggal','$kecamatan','$keluhan', '$gambar_baru', '-','$waktu')");
        
        if ($query) {
            echo "<script>
                alert('!keluhan berhasil di kirim!');
                document.location.href = 'keluhan2.php';
            </script>";
        } else {
            echo "<script>
                alert('!keluhan gagal terkirim!');
...
<img src="img/LOG1.jpg" alt='a' style="float:right;width:50px;height:50px;padding:10;"></a></div>
...
<div class="containerK1">
    <div class="container">
            <div class="form-header">
                <h2 style="Color: white; text-align:center; font-size: 35px;">Apa keluhan anda</h2>
            </div>

            <div class="form-area">
                    <div class="form-input">
                        <input type="text" name="nama" autocomplete="off" placeholder="Nama" required>
                    </div>
                </div>

            <div class="form-area">
                    <div class="form-input">
                        <input type="int" name="nik" autocomplete="off" placeholder="NIK" required>
                    </div>
                </div>
            
            <div class="form-area">
                    <div class="form-input">
                        <input type="date" name="tanggal" autocomplete="off" placeholder="Tanggal" required>
                    </div>
                </div>
                ...
                <div class="form-area">
                    <div class="form-label">
                        ...
                        <select id="gender" name="kecamatan">
            ...
            <div class="containera">
                <div class="form-area">
                    ...
                    <div class="form-input">
                    <textarea rows="10" cols="83" name="keluhan" autocomplete="off" required></textarea>
                    </div>
    ...
    <footer><a>Copyright 2022. ADITYA RAFIQI PANGESTU. Hak cipta dilindungi ADITCEPU.</a></footer>
    <a href="keluhan2.php"><button class="backk">MENU</button></a>
